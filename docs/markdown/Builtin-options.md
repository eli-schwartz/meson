...
| Option           | Default value | Possible values             | Description |
| ------           | ------------- | -----------------           | ----------- |
| bytecompile      | 0             | integer from -1 to 2        | What bytecode optimization level to use (Since 1.1.0) |
...
*Since 1.1.0* The `python.bytecompile` option can be used to enable compiling
