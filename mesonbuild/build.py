...
class Headers(HoldableObject):
    ...
    def __init__(self, sources , install_subdir ,
                 custom_install_dir , custom_install_mode ,
                 subproject ):
...
class Man(HoldableObject):
    ...
    def __init__(self, sources , custom_install_dir ,
                 custom_install_mode , subproject ,
                 locale ):
        self.sources = sources
        self.custom_install_dir = custom_install_dir
        self.custom_install_mode = custom_install_mode
...
class EmptyDir(HoldableObject):
    ...
    def __init__(self, path , install_mode , subproject ,
                 install_tag  = None):
        self.path = path
...
class Build:
    ...
    def __init__(self, environment ):
        ...
        self.dependency_overrides   = PerMachineDefaultable.default(
...
class IncludeDirs(HoldableObject):
    ...
    def __init__(self, curdir , incdirs , is_system , extra_build_dirs  = None):
        self.curdir = curdir
        ...
        # actually exist.
        self.extra_build_dirs  = extra_build_dirs or []
    ...
    def to_string_list(self, sourcedir , builddir  = None)  :
...
class StructuredSources(HoldableObject):
    ...
    def __init__(self, sources=None):
        self.sources = sources if sources is not None else defaultdict(list)
...
class EnvironmentVariables(HoldableObject):
    def __init__(self, values  = None,
                 init_method    = 'set', separator  = os.pathsep)  :
        self.envvars          = []
    ...
    def set(self, name , values , separator  = os.pathsep)  :
        self.varnames.add(name)
        self.envvars.append((self._set, name, values, separator))

    def append(self, name , values , separator  = os.pathsep)  :
        self.varnames.add(name)
        self.envvars.append((self._append, name, values, separator))

    def prepend(self, name , values , separator  = os.pathsep)  :
        self.varnames.add(name)
        self.envvars.append((self._prepend, name, values, separator))

    @staticmethod
    def _set(env  , name , values , separator )  :
        return separator.join(values)

    @staticmethod
    def _append(env  , name , values , separator )  :
        curr = env.get(name)
        return separator.join(values if curr is None else [curr] + values)

    @staticmethod
    def _prepend(env  , name , values , separator )  :
        curr = env.get(name)
...
class Target(HoldableObject):
    ...
    def __post_init__(self)  :
        ...
        self.option_overrides_compiler   = {}
    ...
    def get_default_install_dir(self, env )   :
...
class BuildTarget(Target):
    ...
    def __init__(self, name , subdir , subproject , for_machine ,
                 sources , structured_sources ,
                 objects, environment , kwargs):
    ...
    def validate_win_subsystem(self, value )  :
        value = value.lower()
...
class Generator(HoldableObject):
    ...
    @staticmethod
    def is_parent_path(parent , trial )  :
...
class GeneratedList(HoldableObject):
    ...
    def __init__(self, generator , subdir ,
                 preserve_path_from ,
                 extra_args ):
...
class Data(HoldableObject):
    def __init__(self, sources , install_dir , install_dir_name ,
                 install_mode , subproject ,
                 rename  = None,
                 install_tag  = None,
                 data_type  = None):
        self.sources = sources
...
class SymlinkData(HoldableObject):
    def __init__(self, target, name, install_dir, subproject, install_tag=None):
        self.target = target
        self.name = name
        self.install_dir = install_dir
        self.subproject = subproject
