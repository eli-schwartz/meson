...
class Headers(HoldableObject):
    ...
    install_dir: InitVar[T.Optional[str]]
    install_mode: InitVar['FileMode']
    subproject: str

    def __post_init__(self, install_dir, install_mode):
...
class InstallDir(HoldableObject):
    src_subdir: InitVar[str]
    inst_subdir: InitVar[str]
    install_dir: str
    install_mode: 'FileMode'
    ...
    def __post_init__(self, src_subdir, inst_subdir):
...
class IncludeDirs(HoldableObject):
    ...
    curdir: str
    dirs: InitVar[T.List[str]]
    is_system: bool
    extra_build_dirs: T.Optional[T.List[str]] = None

    def __post_init__(self, dirs):
        self.incdirs = dirs

        # Interpreter has validated that all given directories
        # actually exist.
        self.extra_build_dirs: T.List[str] = self.extra_build_dirs or []
...
class ExtractedObjects(HoldableObject):
    ...
    def __post_init__(self):
        if self.srclist is None:
            self.srclist: T.List[File] = []
        if self.genlist is None:
            self.genlist: T.List['GeneratedTypes'] = []
        if self.objlist is None:
            self.objlist: T.List[T.Union[str, 'File', 'ExtractedObjects']] = []
...
class BuildTarget(Target):
    ...
    def __init__(self, name: str, subdir: str, subproject: str, for_machine: MachineChoice,
        ...
        super().__init__(name, subdir, subproject, build_by_default=True, for_machine)
