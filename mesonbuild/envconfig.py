...
class Properties:
    ...
    def get_pkg_config_libdir(self)  :
    ...
    def get_cmake_toolchain_file(self)  :
    ...
    def get_cmake_skip_compiler_test(self)  :
    ...
    def get_cmake_use_exe_wrapper(self)  :
