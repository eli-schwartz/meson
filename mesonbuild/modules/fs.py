...
class FSModule(ExtensionModule):
    ...
    def _absolute_dir(self, state , arg )  :
        """
    ...
    def as_posix(self, state , args , kwargs  )  :
        """
    ...
    def stem(self, state , args , kwargs  )  :
        if isinstance(args[0], File):
    ...
    def read(self, state , args , kwargs )  :
