...
class ExternalProject(NewExtensionModule):
    ...
    def _validate_configure_options(self, variables   , state )  :
    ...
    def _format_options(self, options , variables   )  :
        ...
        confdata    = {k: (v, None) for k, _, v in variables}
        for o in options:
    ...
    def _run(self, step , command , workdir )  :
    ...
    def dependency_method(self, state , args , kwargs )  :
        libname = args[0]
